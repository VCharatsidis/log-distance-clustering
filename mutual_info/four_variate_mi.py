...
def my_loss_8(joint_probability_1_2_3_4):
    ...
    for num in range(10):
        ...
        sum += - class_weight * torch.log(joint_prob)  # diag_element(joint_probability_1_2_3_4, p_1, p_2, p_3, p_4, number)
...
def my_loss(joint_probability_1_2_3_4):
    ...
    for num in range(10):
        ...
        # prob = (p_1[num, num, num, num] + p_2[num, num, num, num] + p_3[num, num, num, num] + p_4[num, num, num, num])/4
        # print(p_1[num, num, num, num])
        # print(p_2[num, num, num, num])
        # print(p_3[num, num, num, num])
        # print(p_4[num, num, num, num])
        # print()
...
def multi_variate_mutual_info(joint_probability_1_2_3_4):
    ...
    multi_variate_mi = multi_variate_mi.sum()
