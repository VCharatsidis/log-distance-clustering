...
def split_image_to_4(image):
    ...
    image_3 = image[:, :, 0: split_at_pixel, 7:split_at_pixel+7]
    image_4 = image[:, :, width - split_at_pixel:, 7:split_at_pixel+7]

    image_5 = image[:, :, 0: split_at_pixel, height - split_at_pixel:]
    image_6 = image[:, :, width - split_at_pixel:, height - split_at_pixel:]
